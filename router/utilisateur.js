...
utilisateur
  ...
  .get("/:id", param('id').isMongoId().withMessage('L\'ID doit être un ObjectId valide'), authenticateToken,  getUtilisateurById)
  ...
  .delete("/:id", param('id').isMongoId().withMessage('L\'ID doit être un ObjectId valide'), authenticateToken, deleteUtilisateur);
